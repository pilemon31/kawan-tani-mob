...
class FilterPlantsScreen extends StatefulWidget {
  const FilterPlantsScreen({super.key});

  @override
  State<FilterPlantsScreen> createState() => _FilterPlantsScreenState();
}

class _FilterPlantsScreenState extends State<FilterPlantsScreen> {
